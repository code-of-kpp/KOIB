...
namespace Croc.Bpc.GsScannerDriver.SIB2005 

{ 

    /// <summary> 

    /// Структура общей памяти, разделяемой между менеджером драйвера и классом управления сканером версии 2005 
    ...
    { 
        ...
        public const int DotsOneLine = 4864; 
